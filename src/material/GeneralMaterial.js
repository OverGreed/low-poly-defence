...
const program = {
    ...
    uniforms: [
        ...
        {name: 'normalSampler', index: 1, type: 'sampler2D', source: Uniform.texture('normal'), vertex: false},
        {name: 'emissive', index: 2, type: 'sampler2D', source: Uniform.texture('emit'), vertex: false},
