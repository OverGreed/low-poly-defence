...
const program = {
    ...
    attributes: [
        {name: 'vertex', type: 'vec3', morph: true},
        {name: 'normal', type: 'vec3', morph: true},
        {name: 'uv', type: 'vec2'}
    ],
    uniforms: [
        ...
        {name: 'emissive', index: 1, type: 'sampler2D', source: Uniform.texture('emit'), vertex: false},
        ...
        {name: 'shadows', index: 2, array: 5, type: 'sampler2D', source: Uniform.data('shadows'), vertex: false},
        {name: 'lights', type: {
            name: 'Light',
            data: [
                { name: 'type', type: 'int' },
        ...
        },  array: 10, source: Uniform.data('lights'), vertex: false},
        {name: 'morph', type: 'float', source: Uniform.mesh('geometry', 'animate'), fragment: false},
...
export default class MorphMaterial extends Material {
    constructor(context, {
        shininess = 250,
        ...options
    }) {
